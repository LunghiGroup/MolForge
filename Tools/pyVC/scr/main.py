...
def run_compute_dof(disp, dof, eig_val_a, eig_vec_a, input_dict, base_folder, path_eq):
...
def main(input_file):
    ...
    if input_dict['calculation'] == 'overlap':
      ...
      with concurrent.futures.ProcessPoolExecutor(max_workers=nproc) as executor:
           futures = [executor.submit(run_compute_dof, disp, dof, eig_val_a, eig_vec_a, input_dict, base_folder, path_eq) for disp in disp_dir for dof in dof_dir]
