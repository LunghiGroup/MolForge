      subroutine xyztoxray(hinv,cell)
      implicit none
      double precision  :: deg2rad,pi,alpha,beta,gamma,a,b,c,V,hinv(3,3),cell(6)
      ...
      subroutine xraytoxyz(h,cell)
      implicit none
      double precision      :: deg2rad,pi,alpha,beta,gamma,a,b,c,V,h(3,3),cell(6)
      ...
      subroutine dist_pbc(v1,v2,h,hinv,dist,nrep)
      implicit none
      double precision                :: v1(3),v2(3),h(3,3),hinv(3,3)
      double precision                :: v(3),a(3),b(3),dist
      integer                         :: i,nrep
