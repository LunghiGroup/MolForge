        ...
        integer                       :: Nloc_row,Nloc_col,blacs_pnum
         ...
         if(mpi_id.eq.0)then
          ...
          write(*,*) '********************************************************************************'
          write(*,*) '****                                                                        ****'
          write(*,*) '****                           SPIRAL@MolForge v1.0_beta                    ****'
          write(*,*) '****                                                                        ****'
          write(*,*) '****                A FORTRAN2003+MPI software for the simulation           ****'
          write(*,*) '****                 of quantum spin-lattice dynamics interfaced            ****'
          write(*,*) '****                 with ab initio and machine learning methods            ****'
          write(*,*) '****                                                                        ****'
          write(*,*) '****                   Author and Copyright: Alessandro Lunghi              ****'
